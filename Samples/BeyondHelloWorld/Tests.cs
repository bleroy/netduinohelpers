...
using MFHelpers.Hardware;
using MFHelpers.Imaging;
using MFHelpers.Helpers;
...
namespace HelloNetduino
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            JoystickButton = new PushButton(Target: new NativeEventHandler(ButtonEventHandler));

            try {
                // Load the resources from the SD card 
                // Place the content of the \Resources folder at the root of an SD card
